...
class MeshStatisticCalculator:
    ...
    def save_distributions_histograms(self, graf_dict):
        if graf_dict["rmse"]:
            self.save_rmse_distributions_histograms()
        if graf_dict["r"]:
            self.save_r_distributions_histograms()
        if graf_dict["area"]:
            self.save_area_distributions_histograms()
        if graf_dict["pair_plot"]:
            self.save_pair_plot_distributions_histograms()
