...
class ScanABC(ABC):
    ...
    def update_scan_borders(self, scan, point):
        """
...
class ScanLite(ScanABC):
    ...
    def insert_scan_in_db_from_scan(self, updated_scan, db_connection=None):
        """
...
class ScanLoader:
    ...
    def calk_scan_metrics(self, scan_id):
        """
    ...
    def update_scan_in_db_from_scan(self, updated_scan, db_connection=None):
        """
...
class MeshStatisticCalculator:
    ...
    def __init__(self, mesh, file_path="."):
        ...
        try:
            ...
            remove(os.path.join(self.file_path, file_name))
...
class ASTinUI(QWidget):
    ...
    def start_calculation(self):
        ...
        if self.cb_save_db.isChecked() is False:
            engine.dispose()
            remove(os.path.join(".", DATABASE_NAME))
        ########################################################################
